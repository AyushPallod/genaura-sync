...
export function saveSnapshot(skills) {
    const snapshotPath = getSnapshotPath();
...
export function createSnapshot(sourcePath) {
...
export function diffSourceToTarget(sourcePath, targetPath) {
    const result = {
        added: [],
        removed: [],
        modified: [],
...
export function getTargetDiffs(sourcePath, targets) {
    const results = [];
